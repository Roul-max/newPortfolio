        ...
        <div className="mb-4 w-[92vw] max-w-[380px] rounded-3xl border border-border/60 bg-background/92 shadow-[0_35px_70px_-40px_rgba(14,75,79,0.85)] backdrop-blur-xl overflow-hidden">
          <div className="relative overflow-hidden rounded-3xl">
            ...
            <div className="relative px-4 py-4 space-y-4 text-sm">
              <div className="rounded-2xl bg-muted/70 px-4 py-3 text-muted-foreground">
              ...
              <div className="rounded-2xl border border-border/60 bg-background/90 px-4 py-3">
                ...
                <textarea
                  ...
                  className="mt-2 w-full bg-transparent text-sm text-foreground placeholder:text-muted-foreground focus:outline-none min-h-[110px] resize-none"
                  placeholder="Describe your product idea..."
                />
              </div>

              {reply && (
                <div className="rounded-2xl border border-border/60 bg-background/90 px-4 py-3 text-sm text-foreground whitespace-pre-line">
                  {reply}
                </div>
              )}
