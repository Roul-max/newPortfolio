      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
        <div className="text-center md:text-left">
          ...
          <p className="text-slate-400 text-sm max-w-xs leading-relaxed">
            Building digital experiences that matter with precision engineering and high-end design.
          </p>
        </div>
          ...
          <div className="flex gap-4">
            {socials.map((social) => (
              <motion.a
                ...
                className="w-10 h-10 bg-white/5 border border-white/10 rounded-lg flex items-center justify-center text-slate-400 hover:text-white transition-all"
              >
        ...
        <div className="flex flex-col items-center md:items-end gap-4">
          ...
          >
            Back to Top
            <svg className="w-5 h-5 p-1 bg-white/5 rounded-full group-hover:bg-indigo-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
